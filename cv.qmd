...
-   [**Thesis:**](https://github.com/bbtheo/ds-thesis) Applying tabular foundation models (TabPFN) to the detection of fraud patterns in high-dimensional transaction data.
