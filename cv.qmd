...
-   [**Thesis:**](https://github.com/bbtheo/ds-thesis) Applying tabular foundation models to the detection of fraud patterns in high-dimensional transaction data. Work in progress; [current draft](https://bbtheo.github.io/ds-thesis/).
